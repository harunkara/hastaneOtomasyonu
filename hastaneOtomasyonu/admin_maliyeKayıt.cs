...
{
    public partial class admin_maliyeKayıt : Form
    {
        public admin_maliyeKayıt()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sql = "Select  * From maliye_kayıt where tc= '" + textBox1.Text.Trim() + "'";
                ...
                else
                {
                    ...
                    {
                        SqlCommand kmt = new SqlCommand("insert into maliye_kayıt (tc,ad,soyad,dogumtarihi,cinsiyet,sifre) values('" + textBox1.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + dateTimePicker1.Text + "','" + comboBox1.GetItemText(comboBox1.SelectedItem) + "','" + textBox4.Text.ToString() + "')", baglantı);
        ...
        private void maliyeKayıt_Load(object sender, EventArgs e)
        {
